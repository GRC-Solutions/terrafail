...
resource "aws_lb_listener" "TerraFailAPIv2_listener" {
  # Drata: Set [aws_lb_listener.protocol] to one of [<IAC_TLS.HTTPS_CAPS: 'HTTPS'>, <IAC_TLS.TLS_CAPS: 'TLS'>] to ensure secure protocols are being used to encrypt resource traffic
